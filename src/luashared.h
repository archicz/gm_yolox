...
public:
    ...
    virtual void        PushUserdata(UserData* ud) = 0;
...
#define GMOD_MODULE_EXPORT extern "C" __declspec(dllexport)

#define GMOD_MODULE_OPEN()                                      \
            int gmod13_open__Imp(ILuaBase* LUA);                \
            GMOD_MODULE_EXPORT int gmod13_open(lua_State* L)    \
            {                                                   \
...
#define GMOD_MODULE_CLOSE()                                     \
            ...
            GMOD_MODULE_EXPORT int gmod13_close(lua_State* L)   \
            {                                                   \
